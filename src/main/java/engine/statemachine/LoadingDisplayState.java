...
public final class LoadingDisplayState extends ScenegraphState {
    ...
    public LoadingDisplayState(final NativeCanvas canvas, final PhysicalLayer physicalLayer,
            ...
            final StateInitializationRunnable<GameState> gameStateInitializationRunnable, final FontStore fontStore,
        ...
        levelTextLabel = new BMText("Level Index Text", "", fontStore.getFontsList().get(2), BMText.Align.Center,
        ...
        final InputTrigger exitTrigger = new InputTrigger(new KeyPressedCondition(Key.ESCAPE),
                toUnloadingDisplayTriggerAction);
