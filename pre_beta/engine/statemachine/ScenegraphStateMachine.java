...
public class ScenegraphStateMachine extends StateMachineWithScheduler<ScenegraphState,String>{
    ...
    public ScenegraphStateMachine(final Node parent,final NativeCanvas canvas,
        ...
        final TransitionTriggerAction<ScenegraphState,String> gameToPauseMenuTriggerAction=new TransitionTriggerAction<ScenegraphState,String>(internalStateMachine,gameToPauseMenuEvent,new Arguments(new int[]{-1}),renderContext);
        final TransitionTriggerAction<ScenegraphState,String> gameToPauseMenuTriggerActionForExitConfirm=new TransitionTriggerAction<ScenegraphState,String>(internalStateMachine,gameToPauseMenuEvent,new Arguments(new int[]{-1},PauseMenuStateEntryAction.EXIT_CONFIRM_TAG),renderContext);
        ...
        final TransitionTriggerAction<ScenegraphState,String> pauseMenuToGameOverTriggerAction=new TransitionTriggerAction<ScenegraphState,String>(internalStateMachine,pauseMenuToGameOverEvent,new Arguments(new int[]{-1}),renderContext);
        ...
        final TransitionTriggerAction<ScenegraphState,String> unloadingDisplayToLoadingDisplayTriggerAction=new TransitionTriggerAction<ScenegraphState,String>(internalStateMachine,unloadingDisplayToLoadingDisplayEvent,new Arguments(new int[]{-1}),renderContext);
        ...
        //TODO use an argument of a transition to pass the figures to the game over state
        final TransitionTriggerAction<ScenegraphState,String> gameToGameOverTriggerAction=new TransitionTriggerAction<ScenegraphState,String>(internalStateMachine,gameToGameOverEvent,new Arguments(new int[]{-1}),renderContext);
        ...
        taskManager.enqueueTask(new StateInitializationRunnable<UnloadingDisplayState>(unloadingDisplayState));
