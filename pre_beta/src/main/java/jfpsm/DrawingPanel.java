...
/**
 * Panel that allows the drawing. The current color is the color of the selected
 * tile.
 * 
...
class DrawingPanel extends JPanel {
     ...
     *            image used to draw
     * @param zoomParams
     *            zoom parameters (zoom disabled if null)
     * @param viewer
     *            viewer that displays this panel
     */
    DrawingPanel(String title, BufferedImage bufferedImage, ZoomParameters zoomParams,
            JFPSMProjectUserObjectViewer viewer) {
        super();
        this.viewer = viewer;
        this.title = title;
