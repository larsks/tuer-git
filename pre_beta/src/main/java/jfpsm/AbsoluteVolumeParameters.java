...
final class AbsoluteVolumeParameters {
    ...
    public final void setLevelRelativePosition(final float x, final float y, final float z) {
        translation[0] = x;
        translation[1] = y;
        translation[2] = z;
    }
    ...
    public final Entry<int[][][], int[][]> getVerticesIndicesOfAdjacentMergeableFacesAndAdjacencyCoordIndices(
            RegularGrid grid) {
        return (volumeParam != null
                ? volumeParam.getVerticesIndicesOfAdjacentMergeableFacesAndAdjacencyCoordIndices(grid) : null);
    }
