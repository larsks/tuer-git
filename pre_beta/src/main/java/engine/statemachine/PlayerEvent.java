...
public enum PlayerEvent {
    ...
    AVAILABLE,
    /**
     * event that may allow to come back to a state allowing to start any
     * operation
     */
    IDLE,
    /**
    ...
    PRESSING_TRIGGER,
    /**
     * event that may lead to wait for the trigger release when the magazine of
     * the current weapon is empty or the attack with a non fully automatic
     * weapon has ended)
     */
    ...
    RELOADING,
    /**
     * event that may lead to a switch to the previous weapon but that runs the
     * "put back" first
     */
    PUTTING_BACK_BEFORE_SELECTING_PREVIOUS,
    /**
     * event that may lead to a switch to the next weapon but that runs the
     * "put back" first
     */
    PUTTING_BACK_BEFORE_SELECTING_NEXT,
    /**
     * event that may lead to a reload of the current weapon but that runs the
     * "put back" first
     */
