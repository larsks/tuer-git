...
public class OggClip {
	...
	public OggClip(String ref) throws IOException{
		//FIXME: not sure it works in my case
	...
	public void setGain(float gain){
		...
		this.gain = gain;		
		if(outputLine!=null)
		    {try{FloatControl control = (FloatControl) outputLine.getControl(FloatControl.Type.MASTER_GAIN);
		         if(gain == -1)
		             control.setValue(0);
		         else 
	...
	public void setBalance(float balance){
        ...
        if(outputLine!=null)
            {try{FloatControl control = (FloatControl) outputLine.getControl(FloatControl.Type.BALANCE);
